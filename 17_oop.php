...
class User {
  // Properties are just attributes which belong to a class.
...
$user1 = new User('Josh', 'josh@gmail.com', '123456');
echo $user1->getName();
echo $user1->login();
...
$employee1 = new employee('Josh','joshua@gmail.com','123','Manager');
